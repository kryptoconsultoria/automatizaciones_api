        ...
        TRY
            ...
            FOR    ${archivo}    IN    @{archivos}
                ...
                IF    '${extension}' == 'xlsx' or '${extension}' == 'xls'
                    ...
                    ${lista_opciones}    Split String    AFP,ARL,CCF,EPS,ICBF,SENA,TOTAL    separator=,
                    ...
                    FOR    ${item}    IN    ${lista_opciones}
                        ...
                        ${sql}    Catenate
                        ...    SELECT idPlanillas
                        ...    FROM planillas WHERE Riesgo like '%${item}%'            
                        ...
                        ${sql}    Catenate
                        ...    SELECT idPlanillas
                        ...    FROM planillas WHERE Riesgo like '%${lista_opciones}[${contador}]%'            
                        ...
                        ${razon_social_registrada}    Query     ${sql}
                        ...
                        FOR    ${fila}    IN    @{AFP}
                            ...
                            ${sql}    Catenate
                            ...    SELECT count(*) FROM planillas_resumen
                            ...    RazonSocial LIKE '%${item}%'
                            ${razon_social_registrada}    Query     ${sql}

                            IF    ${razon_social_registrada}[0][0] = 0
                                ${sql}    Catenate    INSERT INTO  planillas_resumen 
                                ...    (RazonSocial,ValorAPagar) VALUES ('${riesgo}','${valor_a_pagar}')   
                            ELSE
                                ${sql}    Catenate    
                                ...    UPDATE planillas_resumen SET 
                                ...    SaldoCtasPagar="${valor_a_pagar}" 
